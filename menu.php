<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm p-3">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="adminDropdown">
                        <li><a class="dropdown-item" href="manage_events.php"><i class="fas fa-calendar-alt"></i> Gestion des événements</a></li>
                        <li><a class="dropdown-item" href="manage_users.php"><i class="fas fa-users"></i> Gestion des utilisateurs</a></li>
                    </ul>
                </li>
            <?php endif; ?>
        ...
        <ul class="navbar-nav ml-auto">
            <?php if (isset($_SESSION['user_id'])): ?>
                <li class="nav-item">
                    <a class="btn btn-outline-danger btn-sm ml-2" href="logout.php"><i class="fas fa-sign-out-alt"></i> Déconnexion</a>
                </li>
            <?php else: ?>
                <li class="nav-item">
                    <a class="btn btn-outline-primary btn-sm ml-2" href="login.php"><i class="fas fa-sign-in-alt"></i> Connexion</a>
                </li>
            <?php endif; ?>
        </ul>
    </div>
